...
<div class="container-fluid" style=" padding-top: 8%;">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Informations sur Nos Partenaires</h1>
    <p class="mb-4">Plongez dans un réseau où chaque nom incarne une expertise exceptionnelle. Bienvenue dans l'élite de la sécurité.</p>

    <!-- DataTales Example -->
    <div class="card shadow mb-4"  style="width: 1200px;">
        <div class="card-header py-3">
            <h6 class="m-1 font-weight-bold text-center" style="color: #201F25">Partenaires en Sécurité</h6>
        </div>
        <div class="card-body" >
            <div class="table-responsive">
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"><div class="dataTables_length" id="dataTable_length"></div></div><div class="col-sm-12 col-md-6"><div id="dataTable_filter" class="dataTables_filter"></div></div></div><div class="row"><div class="col-sm-12"><table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                    ...
                    <tr role="row">
                        ...
                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" >Nom Société</th>
                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" > Adresse Société</th>
                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending">Tel Société</th>
                    ...
                    <tbody>
                    @if($donsoc)
                    @foreach($donsoc as $soc)
                    <tr class="odd">
                        <td class="sorting_1">{{ $soc->id }}</td>
                        <td>{{ $soc->nomsoc }}</td>
                        <td>{{ $soc->adressesoc }}</td>
                        <td>{{ $soc->telsoc }}</td>
                        <td style="display: flex; justify-content: space-evenly;">
              <span>
                <form action="{{route('updatesoc')}}" method="get">
                    <input type="hidden" value="{{ $soc->id }}" name="socparam">
                  <button style="background-color: transparent; border: none; color: grey"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill hover-green" viewBox="0 0 16 16">
                    <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001"/>
                            ...
                            <span>
                <form action="{{route('suppsoc')}}" method="post">
                    <input type="hidden" value="{{ $soc->id }}" name="socparam1">
